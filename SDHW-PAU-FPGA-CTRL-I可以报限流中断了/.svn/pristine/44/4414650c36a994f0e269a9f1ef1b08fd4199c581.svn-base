...
(
    ...
    output [ 1:0] in_value_update , 
    output [31:0] out_value       ,
    output [ 3:0] out_value_update,
    input         inlet_scl_in    ,
    ...
    assign min_in_temp     =  (in_value [15:8 ]>in_value [7:0  ]) ? in_value [7:0  ]:in_value [15:8 ];                                           
    assign max_out_temp_01 =  (out_value[15:8 ]>out_value[7 :0 ]) ? out_value[15:8 ]:out_value[7 :0 ];                           
    assign max_out_temp_23 =  (out_value[31:24]>out_value[23:16]) ? out_value[31:24]:out_value[23:16];                                                                       
