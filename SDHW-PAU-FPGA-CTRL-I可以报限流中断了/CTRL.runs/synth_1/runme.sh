...
HD_PWD='C:/Users/admin/Desktop/SDHW-PAU-FPGA-CTRL-I/CTRL.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CTRL_FPGA.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CTRL_FPGA.tcl
