...
HD_PWD='C:/Users/admin/Desktop/SDHW-PAU-FPGA-CTRL-I/CTRL.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CTRL_FPGA.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CTRL_FPGA.tcl -notrace
