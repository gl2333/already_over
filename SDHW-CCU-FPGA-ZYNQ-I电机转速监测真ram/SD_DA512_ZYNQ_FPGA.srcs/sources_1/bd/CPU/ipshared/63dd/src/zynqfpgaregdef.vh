`ifndef ZYNQFPGAREGDEF__V__
    ...
    `define FIRMWARE_COMPILE_DATE 32'h20190408
    `define FIRMWARE_COMPILE_TIME 32'h00134537
...
//Interval sampling usm pulse

    `define USM_SAMPLE_INTV_NUM       5
    `define USM_SAMPLE_INTV_BIT_WID   32
    `define USM_SAMPLE_INTV_ADDR      444	//32bit width addr
    `define USM_SAMPLE_INTV_SIZE      1		//32bit width size
    `define USM_SAMPLE_INTV_END       448	//32bit width addr
    `define USM_SAMPLE_INTV_BYTE_ADDR 16'h06f0//8bit width addr
    `define USM_SAMPLE_INTV_BYTE_WID  4		//8bit width size
    `define USM_SAMPLE_INTV_BYTE_END  16'h0703//8bit width addr

//Add 1 at sample interval
    `define USM_SAMPLE_DEPTH_NUM       5
    `define USM_SAMPLE_DEPTH_BIT_WID   16
    `define USM_SAMPLE_DEPTH_ADDR      449	//32bit width addr
    `define USM_SAMPLE_DEPTH_SIZE      1		//32bit width size
    `define USM_SAMPLE_DEPTH_END       453	//32bit width addr
    `define USM_SAMPLE_DEPTH_BYTE_ADDR 16'h0704//8bit width addr
    `define USM_SAMPLE_DEPTH_BYTE_WID  2		//8bit width size
    `define USM_SAMPLE_DEPTH_BYTE_END  16'h0715//8bit width addr

//Addr in Bram to be read
    `define USM_SAMPLE_INDEX_NUM       5
    `define USM_SAMPLE_INDEX_BIT_WID   16
    `define USM_SAMPLE_INDEX_ADDR      454	//32bit width addr
    `define USM_SAMPLE_INDEX_SIZE      1		//32bit width size
    `define USM_SAMPLE_INDEX_END       458	//32bit width addr
    `define USM_SAMPLE_INDEX_BYTE_ADDR 16'h0718//8bit width addr
    `define USM_SAMPLE_INDEX_BYTE_WID  2		//8bit width size
    `define USM_SAMPLE_INDEX_BYTE_END  16'h0729//8bit width addr

//Read Bram
    `define USM_SAMPLE_READ_NUM       5
    `define USM_SAMPLE_READ_BIT_WID   1
    `define USM_SAMPLE_READ_ADDR      459	//32bit width addr
    `define USM_SAMPLE_READ_SIZE      1		//32bit width size
    `define USM_SAMPLE_READ_END       463	//32bit width addr
    `define USM_SAMPLE_READ_BYTE_ADDR 16'h072c//8bit width addr
    `define USM_SAMPLE_READ_BYTE_WID  1		//8bit width size
    `define USM_SAMPLE_READ_BYTE_END  16'h073c//8bit width addr

//Data valid to be read
    `define USM_SAMPLE_VALD_NUM       5
    `define USM_SAMPLE_VALD_BIT_WID   1
    `define USM_SAMPLE_VALD_ADDR      464	//32bit width addr
    `define USM_SAMPLE_VALD_SIZE      1		//32bit width size
    `define USM_SAMPLE_VALD_END       468	//32bit width addr
    `define USM_SAMPLE_VALD_BYTE_ADDR 16'h0740//8bit width addr
    `define USM_SAMPLE_VALD_BYTE_WID  1		//8bit width size
    `define USM_SAMPLE_VALD_BYTE_END  16'h0750//8bit width addr

//Data in Bram to be read
    `define USM_SAMPLE_DATA_NUM       5
    `define USM_SAMPLE_DATA_BIT_WID   32
    `define USM_SAMPLE_DATA_ADDR      469	//32bit width addr
    `define USM_SAMPLE_DATA_SIZE      1		//32bit width size
    `define USM_SAMPLE_DATA_END       473	//32bit width addr
    `define USM_SAMPLE_DATA_BYTE_ADDR 16'h0754//8bit width addr
    `define USM_SAMPLE_DATA_BYTE_WID  4		//8bit width size
    `define USM_SAMPLE_DATA_BYTE_END  16'h0767//8bit width addr

//Min usm sample pulse
    `define USM_SAMPLE_LIMIT_VAL_NUM       5
    `define USM_SAMPLE_LIMIT_VAL_BIT_WID   32
    `define USM_SAMPLE_LIMIT_VAL_ADDR      474	//32bit width addr
    `define USM_SAMPLE_LIMIT_VAL_SIZE      1		//32bit width size
    `define USM_SAMPLE_LIMIT_VAL_END       478	//32bit width addr
    `define USM_SAMPLE_LIMIT_VAL_BYTE_ADDR 16'h0768//8bit width addr
    `define USM_SAMPLE_LIMIT_VAL_BYTE_WID  4		//8bit width size
    `define USM_SAMPLE_LIMIT_VAL_BYTE_END  16'h077b//8bit width addr

//Stop usm move when sample pulse < VAL
    `define USM_SAMPLE_LIMIT_EN_NUM       5
    `define USM_SAMPLE_LIMIT_EN_BIT_WID   1
    `define USM_SAMPLE_LIMIT_EN_ADDR      479	//32bit width addr
    `define USM_SAMPLE_LIMIT_EN_SIZE      1		//32bit width size
    `define USM_SAMPLE_LIMIT_EN_END       483	//32bit width addr
    `define USM_SAMPLE_LIMIT_EN_BYTE_ADDR 16'h077c//8bit width addr
    `define USM_SAMPLE_LIMIT_EN_BYTE_WID  1		//8bit width size
    `define USM_SAMPLE_LIMIT_EN_BYTE_END  16'h078c//8bit width addr

//Reserved for future use
    `define USM_RSV_NUM       5
    `define USM_RSV_BIT_WID   256
    `define USM_RSV_ADDR      484	//32bit width addr
    `define USM_RSV_SIZE      8		//32bit width size
    `define USM_RSV_END       523	//32bit width addr
    `define USM_RSV_BYTE_ADDR 16'h0790//8bit width addr
    `define USM_RSV_BYTE_WID  32		//8bit width size
...
//USM sample value is too small
    `define IRQ_STA_USM_SAMPLE_NUM       5
    `define IRQ_STA_USM_SAMPLE_BIT_WID   1
    `define IRQ_STA_USM_SAMPLE_ADDR      1814	//32bit width addr
    `define IRQ_STA_USM_SAMPLE_SIZE      1		//32bit width size
    `define IRQ_STA_USM_SAMPLE_END       1818	//32bit width addr
    `define IRQ_STA_USM_SAMPLE_BYTE_ADDR 16'h1c58//8bit width addr
    `define IRQ_STA_USM_SAMPLE_BYTE_WID  1		//8bit width size
    `define IRQ_STA_USM_SAMPLE_BYTE_END  16'h1c68//8bit width addr
...
//Reserved for future use
    ...
    `define IRQ_STA_RSV_BIT_WID   352
    `define IRQ_STA_RSV_ADDR      1819	//32bit width addr
    `define IRQ_STA_RSV_SIZE      11		//32bit width size
    `define IRQ_STA_RSV_END       1829	//32bit width addr
    `define IRQ_STA_RSV_BYTE_ADDR 16'h1c6c//8bit width addr
    `define IRQ_STA_RSV_BYTE_WID  44		//8bit width size
...
//USM sample value is too small
    `define IRQ_MASK_USM_SAMPLE_NUM       5
    `define IRQ_MASK_USM_SAMPLE_BIT_WID   1
    `define IRQ_MASK_USM_SAMPLE_ADDR      1904	//32bit width addr
    `define IRQ_MASK_USM_SAMPLE_SIZE      1		//32bit width size
    `define IRQ_MASK_USM_SAMPLE_END       1908	//32bit width addr
    `define IRQ_MASK_USM_SAMPLE_BYTE_ADDR 16'h1dc0//8bit width addr
    `define IRQ_MASK_USM_SAMPLE_BYTE_WID  1		//8bit width size
    `define IRQ_MASK_USM_SAMPLE_BYTE_END  16'h1dd0//8bit width addr
...
//Reserved for future use
    ...
    `define IRQ_MASK_RSV_BIT_WID   352
    `define IRQ_MASK_RSV_ADDR      1909	//32bit width addr
    `define IRQ_MASK_RSV_SIZE      11		//32bit width size
    `define IRQ_MASK_RSV_END       1919	//32bit width addr
    `define IRQ_MASK_RSV_BYTE_ADDR 16'h1dd4//8bit width addr
    `define IRQ_MASK_RSV_BYTE_WID  44		//8bit width size
