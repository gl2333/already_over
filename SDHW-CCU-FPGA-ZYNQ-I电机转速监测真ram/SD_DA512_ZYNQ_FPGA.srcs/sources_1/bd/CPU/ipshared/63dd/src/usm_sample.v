...
reg [`USM_MOVE_PULSE_BIT_WID-1  :0]i_reg_usm_move_pulse_r        ;	
always@(posedge clk)
	if(rst)  		i_reg_usm_move_pulse_r <= 0;
	else         	i_reg_usm_move_pulse_r <= i_reg_usm_move_pulse;	
