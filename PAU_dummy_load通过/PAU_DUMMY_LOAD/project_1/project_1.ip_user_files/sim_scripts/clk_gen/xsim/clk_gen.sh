...
#
# Generated by Vivado on Tue Jul 03 17:25:53 +0800 2018
...
# Script info
echo -e "clk_gen.sh - Script generated by export_simulation (Vivado v2016.4 (64-bit)-id)\n"
...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot clk_gen xil_defaultlib.clk_gen xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  $xv_path/bin/xsim clk_gen -key {Behavioral:sim_1:Functional:clk_gen} -tclbatch cmd.tcl -log simulate.log
}
